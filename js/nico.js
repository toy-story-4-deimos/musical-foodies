...
$(document).ready(function () {
    ...
    function loadAPICuisine(cuisine) {
        fetch(`https://api.spoonacular.com/recipes/search?&apiKey=${foodKey}&number=4&cuisine=${cuisine}`)
            ...
            .then(element => {
                ...
                // $('.card-content-two').html(element.results[1].winePairing.pairingText);
                ...
                // $('.card-content-three').html(element.results[2].winePairing.pairingText);
                ...
                // $('.card-content -four').html(element.results[3].winePairing.pairingText);
    ...
    $("#search-button").click(function () {
        ...
        function autoCompleteSearchBar() {
            fetch(`https://api.spoonacular.com/recipes/search?&apiKey=${foodKey}&number=4&query=${input}`)
                .then(response => response.json())
                .then(element => {
                    console.log(element);
                    $('.header-one').html(element.results[0].title);
